...
int main()
{
    ...
    // Text https://divinacommedia.dante.global/inferno/testo/inf01.htm?utm_source=chatgpt.com
    Enigma engima = Enigma{rotor3, rotor0, rotor2, reflector, PlugBoard{{{'M', 'N'}, {'G', 'Q'}, {'U', 'W'}, {'F', 'K'}, {'L', 'S'}, {'C', 'Z'}}}};
    // std::cout << engima.encrypt("L") << std::endl;
